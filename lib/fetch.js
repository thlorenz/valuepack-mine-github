...
function fetch(retry, options, pagesOpts, lastModified, resource, cb) {
  ...
  var retriesOnHangup = typeof options.retriesOnHangup === 'undefined' ? 1 : options.retriesOnHangup;
  ...
  requestAllPages(opts, pagesOpts, function (err, pages) {
    if (err) {
      ...
      return setImmediate(fetch.bind(null, retry, options, pagesOpts, lastModified, resource, cb));
    }
